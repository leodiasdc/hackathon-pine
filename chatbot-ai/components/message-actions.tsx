    ...
    <TooltipProvider delayDuration={0}>
      <div className="flex flex-row gap-2">
              ...
              onClick={async () => {
                ...
                toast.promise(upvote, {
                  ...
                  success: () => {
                    ...
                    return 'Resposta preenchida!';
                  },
                  error: 'Falha em clicar no botão.',
                });
              }}
            >
              <ThumbUpIcon />
        ...
        <Tooltip>
            ...
            <Button
              ...
              onClick={async () => {
                ...
                toast.promise(downvote, {
                  loading: 'Processando a mensagem...',
                  success: () => {
                    mutate<Array<Vote>>(
                    ...
                    return 'Resposta mal votada!';
                  },
                  error: 'Falha em votar na resposta',
                });
              }}
            >
              <ThumbDownIcon />
          ...
          <TooltipContent>Não gostei da resposta</TooltipContent>
        </Tooltip>
      </div>
    </TooltipProvider>
  );
